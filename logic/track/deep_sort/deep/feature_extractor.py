...
class Extractor(object):
    def __init__(self, model_path='/Users/saidalikhonalikhonov/Documents/GitHub/projects/Capstone/Retail-Heatmap/track/deep_sort/deep/checkpoint/ckpt.t7', use_cuda=True):
